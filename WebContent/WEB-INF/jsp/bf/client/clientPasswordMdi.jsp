            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form onsubmit="return f()" target="_self" method="post" action="bf/clientPasswordMdiDo" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="newPassword1"  style="float: left;width:400px;" type="password" name="client_password" class="form-control"><font style="float: left;width:120px;"  id="a"></font>
                                </div>
                            </div>
                            <div class="form-group">
