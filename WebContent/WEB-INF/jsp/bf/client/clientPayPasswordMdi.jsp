            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form onsubmit="return f()" target="_self" method="post" action="bf/clientPayPasswordMdiDo" class="form-horizontal">
                            <input type="hidden" name="client_id" value="${client.client_id }">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">老支付密码</label>

                                <div class="col-sm-10">
                                    <input type="password"  onchange="f2()" style="float: left;width:400px;" id="password" name="password" class="form-control"><font style="float: left;width:120px;" id="u"></font>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="newPassword1"  style="float: left;width:400px;" type="password" name="client_paypassword" class="form-control"><font style="float: left;width:120px;"  id="a"></font>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">确认新支付密码</label>

                                <div class="col-sm-10">
                                    <input id="newPassword2"  style="float: left;width:400px;" type="password" name="newPassword2" class="form-control"><font style="float: left;width:120px;" ></font>
                                </div>
                            </div>
                            <div class="form-group">
                                <font color="red" id="message">${message }</font>
                            </div>
