            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form target="_self" method="post" action="back/clientMdi1" class="form-horizontal">
                        	...
                        	<input type="checkbox"  <c:forEach items="${facs }" var="f">
                                	<c:if test="${f eq fac.fac_id }">checked="checked"</c:if>
                                </c:forEach> name="fk_clientFac_ids" value="${fac.fac_id }">${fac.fac_name }
                        </c:forEach>
                                </div>
                            </div>
