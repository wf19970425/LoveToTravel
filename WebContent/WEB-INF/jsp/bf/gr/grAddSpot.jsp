            ...
            <div style="height: 500px;overflow: scroll;" class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form target="_self" method="post" enctype="multipart/form-data" action="bf/grAddDoSpot" class="form-horizontal">
                            <input type="hidden" name="fk_grSpot_id" value="${gr.fk_grSpot_id }">
                            <input type="hidden" name="fk_grClient_id" value="${gr.fk_grClient_id }">
                            <input type="hidden" name="pages" value="${pages }">
                            <input type="hidden" name="orsp_id" value="${orsp_id }">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">商品名</label>

                                <div class="col-sm-10">
                                    <input type="text" onchange="f2()" value="${spot_name }" style="float: left;width:400px;"  class="form-control"><font style="float: left;width:120px;" id="u"></font>
                                </div>
                            </div>
                            <div class="form-group">
