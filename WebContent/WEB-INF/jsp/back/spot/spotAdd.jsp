            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form target="_self" method="post" enctype="multipart/form-data" action="back/spotAddDo" class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">景点名</label>

                                <div class="col-sm-10">
                                    <input type="text"  style="float: left;width:400px;" id="spot_name" name="spot_name" class="form-control"><font style="float: left;width:120px;" id="u"></font>
                                </div>
                            </div>
                             <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="spot_addr"  style="float: left;width:400px;" type="text" name="spot_addr" class="form-control"><font style="float: left;width:120px;" ></font>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="spot_time"  style="float: left;width:400px;" type="text" name="spot_time" class="form-control"><font style="float: left;width:120px;" ></font>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="spot_tel"  style="float: left;width:400px;" type="text" name="spot_price" class="form-control"><font style="float: left;width:120px;" ></font>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="spot_child"  style="float: left;width:400px;" type="text" name="spot_child" class="form-control"><font style="float: left;width:120px;" ></font>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea   autocomplete="off" name="spot_message" cols="100" rows="8" style="height:100px;visibility:hidden;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea   autocomplete="off" name="spot_look" cols="100" rows="8" style="height:100px;visibility:hidden;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea   autocomplete="off" name="spot_link" cols="100" rows="8" style="height:100px;visibility:hidden;"></textarea>
                                </div>
                            </div>
