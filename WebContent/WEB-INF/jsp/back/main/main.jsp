...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               ...
                               <span class="block m-t-xs"><strong class="font-bold">${sessionScope.user.user_name }</strong></span>
                                <span class="text-muted text-xs block">${sessionScope.user.role.role_name }<b class="caret"></b></span>
                                </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="javascript:void(0)" onclick="iconMdi()">修改头像</a></li>
                                <li><a class="J_menuItem" href="javascript:void(0)" onclick="userMdi(${sessionScope.user.user_id })">个人资料</a>
                                <li><a class="J_menuItem" href="javascript:void(0)" onclick="passwordMdi()">修改密码</a></li>
                                <li><a href="javascript:void(0)" onclick="backLogin()" >退出登录</a></li>
                                <li><a href="http://localhost:8080/tour1/bf/main">前台登录</a></li>
                            </ul>
                        </div>
                    </li>
                    <c:forEach items="${fatherList }" var="father">
                        <li>
                            <a href="#"><i class="fa fa-table"></i> <span class="nav-label">${father.menu_name }</span><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                               <c:forEach items="${sonList }" var="son">
                               	<c:if test="${father.menu_id eq son.menu.father_menu }">
                               		<li><a class="J_menuItem" href="${son.menu.menu_url }">${son.menu.menu_name }</a></li>
                               	</c:if>
                               </c:forEach>
                            </ul>
                        </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-right"><center>&copy; 2019-4-28 王飞 <h7>联系电话：123456778901 </h7></center>
                </div>
            </div>
        </div>
    </div>
