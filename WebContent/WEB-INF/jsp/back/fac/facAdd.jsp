            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form target="_self" method="post" action="back/facAddDo" class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">类型名</label>

                                <div class="col-sm-10">
                                    <input type="text"  style="float: left;width:400px;" id="fac_name" name="fac_name" class="form-control"><font style="float: left;width:120px;" id="u"></font>
                                </div>
                            </div>
