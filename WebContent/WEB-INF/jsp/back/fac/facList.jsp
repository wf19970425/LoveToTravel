...
<link href="back/artDialog/css/ui-dialog.css" rel="stylesheet"
    ...
    <script type="text/javascript">
        ...
        function facDel(fac_id) {
            var d = top.dialog({
                title: '类型删除',
                url:'back/facDel?fac_id='+fac_id,
                width:'500',
                height:'500',
                onclose:function (){
                    //刷新页面
        ...
        function facMdi(fac_id) {
            var d = top.dialog({
                title: '类型修改',
                url:'back/facMdi?fac_id='+fac_id,
                width:'500',
                height:'500',
                onclose:function (){
                    //刷新页面
        ...
        <div class="row">          
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <div class="ibox-tools">
                           <form target="_self" action="back/facList" >
                                <input type="text" value="${fac.fac_name }" placeholder="请输入类型名" name="fac_name" style="float: left;width:120px;" class="form-control">
            ...
            <th>操作</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="checkbox" name="fac_id" value="${fac.fac_id }" /></td>
                                    <td>${fac.fac_name }</td>
            <td>
              <a title="编辑" class="btn btn-outline btn-info" onclick="facMdi(${fac.fac_id})" href="javascript:;">
                修改
              </a>
              <a title="删除" class="btn btn-outline btn-danger" onclick="facDel(${fac.fac_id})" href="javascript:;">
                删除
              </a>
            </td>
                                </tr>
