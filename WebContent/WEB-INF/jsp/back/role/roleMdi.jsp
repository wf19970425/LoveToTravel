            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form target="_self" method="post" action="back/roleMdiDo" class="form-horizontal">
                        <input type="hidden" name="role_id" value="${role.role_id }">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">角色名</label>

                                <div class="col-sm-10">
                                    <input type="text" value="${role.role_name }" style="float: left;width:400px;" id="role_name" name="role_name" class="form-control"><font style="float: left;width:120px;" id="u"></font>
                                </div>
                            </div>
