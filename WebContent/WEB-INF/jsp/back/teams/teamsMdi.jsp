            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form style="height: 500px;overflow: scroll;" target="_self" method="post" enctype="multipart/form-data" action="back/teamsMdi" class="form-horizontal">
                            <input type="hidden" name="teams_id" value="${teams.teams_id }">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">跟团游名</label>

                                <div class="col-sm-10">
                                    <input type="text"  style="float: left;width:400px;" id="teams_name" value="${teams.teams_name }" name="teams_name" class="form-control"><font style="float: left;width:120px;" id="u"></font>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="teams_tel"  style="float: left;width:400px;" type="text" value="${teams.teams_price }" name="teams_price" class="form-control"><font style="float: left;width:120px;" ></font>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="teams_child"  style="float: left;width:400px;" type="text" value="${teams.teams_child }" name="teams_child" class="form-control"><font style="float: left;width:120px;" ></font>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea   autocomplete="off" name="teams_message" cols="100" rows="8" style="width:100%;height:100px;visibility:hidden;">${teams.teams_message }</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea   autocomplete="off" name="teams_gen" cols="100" rows="8" style="width:100%;height:100px;visibility:hidden;">${teams.teams_gen }</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea   autocomplete="off" name="teams_feat" cols="100" rows="8" style="width:100%;height:100px;visibility:hidden;">${teams.teams_feat }</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea   autocomplete="off" name="teams_spot" cols="100" rows="8" style="width:100%;height:100px;visibility:hidden;">${teams.teams_spot }</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea   autocomplete="off" name="teams_cost" cols="100" rows="8" style="width:100%;height:100px;visibility:hidden;">${teams.teams_cost }</textarea>
                                </div>
                            </div>
