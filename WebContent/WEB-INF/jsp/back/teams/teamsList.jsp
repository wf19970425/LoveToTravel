...
<link href="back/artDialog/css/ui-dialog.css" rel="stylesheet"
    ...
    <script type="text/javascript">
        function teamsMdi(teams_id) {
            var d = top.dialog({
                title: '修改跟团游',
                url:'back/teamsLoad?teams_id='+teams_id,
                width:'600',
                height:'800',
                onclose:function(){
        ...
        function teamsDel(teams_id) {
            var d = top.dialog({
                title: '删除跟团游',
                url:'back/teamsDel?teams_id='+teams_id,
                width:'600',
                height:'800',
                onclose:function(){
                    window.location.reload();
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <div class="ibox-tools">
                           <form target="_self" action="back/teamsList" >
                                <input type="text" value="${teams.teams_name }" placeholder="请输入跟团游名" name="teams_name" style="float: left;width:120px;" class="form-control">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="checkbox" name="teams_id" value="${teams.teams_id }" /></td>
                                    <td><img width="60px" height="60px" src="/upload/${teams.teams_logo }" /></span></td>
                                    <td>${teams.teams_name }</td>
                                    <td>${teams.teams_price }</td>
                                    <td>${teams.teams_child }</td>
                                    <td class="text-navy"><input type="button" onclick="teamsMdi(${teams.teams_id})" value="修改" class="btn btn-outline btn-info"> <input type="button" value="删除" onclick="teamsDel(${teams.teams_id})" class="btn btn-outline btn-danger"></td>
                                </tr>
                                </c:forEach>
                            </tbody>
                        </table>
